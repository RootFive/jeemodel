 ...
 * 		public  class XXX extends BaseEntityCRUD{
 * 		}
...
public abstract class BaseEntityCRUD extends BaseEntityCRD {
	 ...
	 * @param baseDTO
	 */
//	public BaseEntityCRUD(BaseDTOCRUD baseDTOCRUD) {
//		super(baseDTOCRUD);
//		this.status = baseDTOCRUD.getStatus();
//		this.updateTime = baseDTOCRUD.getUpdateTime();
//		this.updateBy = baseDTOCRUD.getUpdateBy();
//	}
