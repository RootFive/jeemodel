...
public class DictUtils {
	...
	public static void setDictCache(String key, List<DictData> dictDatas) {
		SpringUtils.getBean(RedisCacheHelper.class).setObject(getCacheKey(key), dictDatas);
	}
	...
	public static void removeDictCache(String key) {
		SpringUtils.getBean(RedisCacheHelper.class).deleteObject(getCacheKey(key));
	}
	...
	public static void clearDictCache() {
		Collection<String> keys =SpringUtils.getBean(RedisCacheHelper.class).keys(ManageConstants.manage_dict_KEY + "*");
		SpringUtils.getBean(RedisCacheHelper.class).deleteObjects(keys);
	}
	...
	public static String getCacheKey(String configKey) {
		return ManageConstants.manage_dict_KEY + configKey;
	}
}
