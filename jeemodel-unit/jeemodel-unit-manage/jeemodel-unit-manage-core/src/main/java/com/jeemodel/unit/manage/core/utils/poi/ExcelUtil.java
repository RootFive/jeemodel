package com.jeemodel.unit.manage.core.utils.poi;
...
import com.jeemodel.solution.file.utils.FileTypeUtils;
import com.jeemodel.solution.file.utils.FileUtils;
import com.jeemodel.solution.file.utils.ImageUtils;
import com.jeemodel.solution.file.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T> {
			...
			for (int i = titleNum + 1; i <= rows; i++) {
				...
				for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet()) {
					...
					if (String.class == fieldType) {
						String s = DataTypeConvertUtils.toStr(val);
						if (StringUtils.endsWith(s, ".0")) {
							...
							if (StringUtils.isNotEmpty(dateFormat)) {
								...
								val = DataTypeConvertUtils.toStr(val);
							}
						}
					} else if ((Integer.TYPE == fieldType || Integer.class == fieldType)
							&& StringUtils.isNumeric(DataTypeConvertUtils.toStr(val))) {
						val = DataTypeConvertUtils.toInt(val);
					} else if (Long.TYPE == fieldType || Long.class == fieldType) {
						val = DataTypeConvertUtils.toLong(val);
					} else if (Double.TYPE == fieldType || Double.class == fieldType) {
						val = DataTypeConvertUtils.toDouble(val);
					} else if (Float.TYPE == fieldType || Float.class == fieldType) {
						val = DataTypeConvertUtils.toFloat(val);
					} else if (BigDecimal.class == fieldType) {
						val = DataTypeConvertUtils.toBigDecimal(val);
					...
					if (BlankUtils.isNotNull(fieldType)) {
						...
						if (StringUtils.isNotEmpty(attr.targetAttr())) {
							...
							val = reverseByExp(DataTypeConvertUtils.toStr(val), attr.readConverterExp(), attr.separator());
	 ...
	 * @return 结果
	 */
	public PongData<String> exportExcel(List<T> list, String sheetName) {
	 ...
	 * @return 结果
	 */
	public PongData<String> exportExcel(List<T> list, String sheetName, String title) {
	 ...
	 * @return 结果
	 */
	public PongData<String> importTemplateExcel(String sheetName) {
	 ...
	 * @return 结果
	 */
	public PongData<String> importTemplateExcel(String sheetName, String title) {
	 ...
	 * @return 结果
	 */
	public PongData<String> exportExcel() {
		...
		try {
			...
			wb.write(out);
			return PongUtils.okData(filename);
		} catch (Exception e) {
			log.error("导出Excel异常{}", e.getMessage());
	...
	public void setCellVo(Object value, Excel attr, Cell cell) {
		if (ColumnType.STRING == attr.cellType()) {
			...
			String imagePath = DataTypeConvertUtils.toStr(value);
	...
	public Cell addCell(Excel attr, Row row, T vo, Field field, int column) {
		...
		try {
			...
			if (attr.isExport()) {
				...
				addStatisticsData(column, DataTypeConvertUtils.toStr(value), attr);
			}
		} catch (Exception e) {
	...
	public String dataFormatHandlerAdapter(Object value, Excel excel) {
		...
		return DataTypeConvertUtils.toStr(value);
	}
	...
	public String getAbsoluteFile(String filename) {
		String downloadPath = FileConfigHelper.getDownloadPath() + filename;
