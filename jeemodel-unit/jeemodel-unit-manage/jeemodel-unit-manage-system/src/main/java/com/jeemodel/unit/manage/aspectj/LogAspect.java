...
import com.jeemodel.unit.manage.enums.BusinessStatus;
...
public class LogAspect {
	 ...
	 * @throws Exception
	 */
	public void getControllerMethodDescription(JoinPoint joinPoint, Log log, UserLogOper operLog, Object jsonResult)
			throws Exception {
		// 设置action动作
	 ...
	 * @throws Exception 异常
	 */
	private void setRequestValue(JoinPoint joinPoint, UserLogOper operLog) throws Exception {
