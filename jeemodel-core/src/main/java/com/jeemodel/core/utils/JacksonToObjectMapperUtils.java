...
//		jacksonObjectMapperBuilder.modules(javaTimeModule);
		...
		return jacksonObjectMapperBuilder.featuresToEnable(JsonGenerator.Feature.WRITE_BIGDECIMAL_AS_PLAIN);
...
//		jacksonObjectMapperBuilder.featuresToEnable(JsonGenerator.Feature.WRITE_NUMBERS_AS_STRINGS);
	...
	public static ObjectMapper newObjectMapper() {
		Jackson2ObjectMapperBuilder jacksonObjectMapperBuilder = SpringUtils.getBean(Jackson2ObjectMapperBuilder.class);
		Jackson2ObjectMapperBuilder customize = customize(jacksonObjectMapperBuilder);
		return customize.build();
	}
}
