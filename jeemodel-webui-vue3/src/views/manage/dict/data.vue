...
import { optionselect as getDictOptionselect, getType } from "@/api/manage/dict/type";
...
function handleUpdate(row) {
  ...
  getData(dictDataIds).then(response => {
...
function handleExport() {
  proxy.download("manage/dict/data/export", {
    ...queryParams.value
