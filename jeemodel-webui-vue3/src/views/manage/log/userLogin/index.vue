      ...
      <el-row :gutter="10" class="mb8">
         <el-col :span="1.5">
            <el-button
               ...
               :disabled="multiple"
               @click="handleDelete"
               v-hasPermi="['manage:logUserLogin:remove']"
            >删除</el-button>
         </el-col>
         <el-col :span="1.5">
            <el-button
         ...
         <el-col :span="1.5">
            <el-button
               ...
               icon="Download"
               @click="handleExport"
               v-hasPermi="['manage:logUserLogin:export']"
            >导出</el-button>
         </el-col>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除访问编号为"' + logIds + '"的数据项?').then(function () {
    return delLogininfor(logIds);
  }).then(() => {
    getList();
...
function handleExport() {
  proxy.download("manage/log/userLogin/export", {
    ...queryParams.value,
