...
import { addRole, changeRoleStatus, dataScope, delRole, getRole, listRole, updateRole } from "@/api/manage/role/role";
import { roleMenuTreeselect, treeselect as menuTreeselect } from "@/api/manage/menu/menu";
...
function handleAuthUser(row) {
  router.push("/manage/role-auth/user/" + row.id);
}
/** 查询菜单树结构 */
